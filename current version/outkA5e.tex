...
\newfontfamily\SkolarSC[SmallCapsFeatures={RawFeature=+c2sc}]{Alegreya}%``small caps features'' forces the small caps to display all lower case, including proper small-caps numbers, while the renderer=basic allows microtype to do the letterspacing. A separate font must be defined for each kind of small caps.

\newfontfamily\stufont{Heuristica}
...
\frontmatter
\pagestyle{empty}
\includegraphics[scale= 1, trim= 62 70 140 63]{outkA5.jpg}
...
\vspace*{\fill}
\includegraphics[scale=0.08, trim = 0 0 0 0 ]{logo-enso-large1}\\
\vspace {0.5em}
%\begin{sc}
\small\stufont\textsc{Wisdom \& Wonders}\\*

\small\stufont\textsc{Books}
%\end{sc}
...
\noindent Creative Commons Attribution-NonCommercial-NoDerivatives 4.0\\ 
\noindent International (CC BY-NC-ND 4.0) 
...
Yet the true genius of a powerful spiritual teacher is to come up with new ways of expressing ancient wisdom. The word \emph{kindfulness} combines a deep appreciation of the working of the Dhar\-ma with a playful imagination, both of which are hallmarks of Ajahn Brahm’s approach to Buddhism. Through profound understanding and light-hearted delivery, he imparts these life-changing teachings in an attractive manner to the world at large. Fun and wisdom, wisdom and fun. They always go together. And they are beautifully encapsulated in that innovative word: Kindfulness. 
...
Do you know the word in Cantonese for very good? It’s ‘Ho ho ho’. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} Now I understand that Santa Claus is Chinese; he doesn’t come from the North Pole but from the Far East! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} ‘Ho ho ho’ is an example of Kindfulness: being aware and giving kindness. 
...
Metta is awesome, Dharma is cool. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{star.png}
...
Now the wife—wives know how to soothe their husbands \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} —soothed him down until he calmed down enough to come to his senses. 
...
The moral of that story is this: if you come home and your wife scolds you, don’t get upset. She’s probably hit her head that day. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} 
...
If you are going to recall your past, forgive all the rotten things which have happened and have metta towards yourself so that you can get rid of all the guilt and suffering. And don’t forget that if you need some punishment, go and find a cat or a dog and stroke until you’ve got no guilt left. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
The trouble with Ajahn Chah is that you can’t argue with him. It was true. What he was saying was true. It didn’t matter what happened, the fever wouldn’t last. Either I’d get better or I’d die. Fortunately, I got better. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}

So why worry about the future? Whatever happens it is not going to last. This positive attitude towards the future has helped me so many times. If you cultivate loving kindness: no matter what happens, you’ll always be able to do something about it. If you die young, you don’t have to worry about going to an old people’s home. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png} 
...
And advantage number three: the best advantage of dying at 30,000 feet above is that you are already halfway to heaven! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} 
...
\begin{center}
\includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}  \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png}  \includegraphics[scale=0.35, trim = 0 10 0 10] {smile.png} 
\end{center}

Once the adverts were finished, we were back in the temple, where Little Grasshopper started to wobble and to sway… Then, he fell in! Poor little Grasshopper fell into the acid! But the master, the supposedly most compassionate man, started laughing! How could he do that? Little Grasshopper was splashing in the pool, but he wasn’t burning. It was only water. And the bones? The master just tossed those in for what we now call special effects. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} 
...
Another thing about Right View is an issue on organ donation. Here in Australia, there are fewer organs donated than the number of people who need them. In Buddhism, there’s nothing wrong with being an organ donor. I’m happy to donate all of my organs. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}
...
This is actually part of letting go and being kind to yourself. You know you did your very best though you could have done better. You’re not perfect. We all could always do better. I could always tell better jokes. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} But you can always be kind and more forgiving. 
...
My teacher Ajahn Chah said that food for the body was not enough. So the most important meal is happening now because this talk is food for the heart. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png}
...
You must have noticed at lunch just how fast things disappear… from your plate. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} You also notice the joy of the taste lasts for a moment and then it’s gone. Sometimes the expectation is the most delicious. For many people, anticipation is the happy part. As soon as you get it, the happiness or the wonderful taste goes away so quickly. 
...
One of my favourite sayings is from a guy who’s just got married: “I didn’t know what happiness was until I got married, and then it was too late!” These are only jokes. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} Marriage can be happy and fulfilling. 
...
I then gave her a few tips on how to make her marriage work. I’m not against marriage; I was just having fun making jokes about marriages. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
It’s strange how marketing works. One of the stories was from a time when I was a young student. I saw an advertisement on TV for St. Bruno Tobacco. It was a great advertisement. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
In about one minute, there was a long line of incredibly gorgeous women following this ordinary-looking guy because St. Bruno Tobacco captivated women. Stupid, wasn’t it? Do you believe that? I did. I bought some St. Bruno Tobacco. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} No, it didn’t work for me. Nobody followed me down the street. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{cry.png} 

Why is it that we have these fantasies and dreams about what life can give us and we get sucked in? We always think things could be better. But really whatever you have is good enough. So be happy with it. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}
...
It’s having a big ego that causes pride. Are you a proud person, too proud to admit you make mistakes sometimes? How many people here have never made a mistake? Put your hand up if you’ve never made a mistake. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png} Proud people never think they’ve made a mistake. Or, they try to hide it under the carpet and pretend that nobody’s noticed. 
...
As my penance, I tell that story often. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} I wrote it in my book \emph{Opening the Door of Your Heart}, as well. The point is that we all make mistakes, and it’s the ego that stops us from admitting that we are at fault, and it’s the ego that stops us from asking for forgiveness. 
...
Sometimes I say the wisest things, which even inspire myself! “Where did that one come from?” \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} At other times, I say dumb things so that I get into trouble for it afterwards. But which one is the right Ajahn Brahm? None of them are. It’s just that you’re always changing to suit circumstances. 
...
The first thing I always like to impress upon people is that this law of karma is not about the common simplistic idea that karma means if you punched your mother when you were young, you’re going to have hay fever in your nose for the rest of your life. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} Or, whatever you’re experiencing now is because you’ve done something similar to somebody else in the past. That idea of action and punishment is something which has never made sense to me at all. It is far too naive and simplistic. 
...
The secret is in this moment, absolutely for free. Truth is like air—no one can own it; we all share it. You can pollute the air, and people can pollute truth, still there’s enough truth out there, and you just need to breathe in. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}
...
Just take away the will to live, the will to die or the will to go anywhere, and just be. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png} 
...
People are also fantasising or dreaming because their fantasy world is much more fun than listening. That’s why you have to tell jokes every now and again to keep people’s attention. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png}
...
There are other times, it’s one or two o’clock in the morning and my body says it doesn’t want to go to sleep but it wants to meditate. Fine. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
A very beautiful way of relaxing is to go into a forest or to the beach and listen to the sounds of the waves and the birds. There’s always something happening in a forest and the wonderful thing is: it’s happening now! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{star.png} There are no echoes in forests. There are no echoes on the beach. Whatever sound is occurring is right in this present moment. It takes away all the busyness of the past and the future. 
...
Then, you totally listen to yourself. Though you may say stupid things (I say a heap of stupid things \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}), you’re listening and loving and accepting, as well as listening to the reaction which happens inside you. At last, you’ll find some peace, some self-respect, some acceptance of yourself. 
...
\textbf{Ajahn Brahm:} People only complain and criticise because they’re crazy! Who in their right mind would complain and criticise when they don’t know what they’re talking about? They don’t know you, so how can they judge you? Sometimes people criticise me, but it wasn’t me who did it. And sometimes people praise me, but I didn’t do it. So I decided to let it be like water off a duck’s back. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
I decided I’m going to take control of my happiness, so you can call me the fattest, most stupid monk you’ve ever seen, and I will not get angry. I’m going to be happy no matter what people say. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}
...
That’s what I did when I was a young man. I became a Buddhist, but I loved beer. My teacher encouraged me to quit, so I tried. As soon as I tried it, I felt this great sense of power inside of me. I had the choice, and I was exercising the choice. I could take it or leave it. I was proving to myself that I could leave it. I could go to a party, still enjoy myself, and actually I found it was more fun when I was sober. Which meant ‘what’s the point of going back to alcohol?’ \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png} 
...
I trust in that now, and it makes life so much easier. You can program things into your mind, and it works so well. For a married person, you don’t have to keep worrying about your partner’s birthday. Just tell yourself: ‘I must remember tomorrow to get my partner a present.’ It saves a lot of suffering! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png}
...
When I first came to Australia, another monk was the head monk for the first 10 years. When he left, I became the boss. We tend to be a bit of a control freak when we first start as a boss. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png}
...
First of all, notice that it is an addiction—a mental addiction to negativity. Once you realise it’s an addiction and want to overcome it, you just try to have half an hour of no negativity. Just try it out temporarily by sitting down and meditating. You can always go back to your fault-finding mind afterwards. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{wink.png} Remember meditation is about being at peace with yourself, including your stupid mind. Your mind can go all over the place or be absolutely ridiculous, or you can fall asleep, but you don’t find fault. 
...
Many years ago, a gentleman came up to me and said, “I hear you are a very wise monk, so can you teach me what Buddhism is? I’ve only got about a minute because I have to go to work.” \includegraphics[scale=0.35, trim = 0 10 0 10 ]{openmouth.png} Instead of saying that was impossible, I liked to challenge myself. What I came up with is: 
...
I still recall many years ago there was a lady who came here and lay down and fell asleep during meditation, pointing her feet towards the Buddha. According to the traditions, we’re not supposed to point our feet to the Buddha statue; it’s disrespectful. Two, you’re not supposed to lie down while other people are sitting. And also, you’re not supposed to fall asleep and start snoring when other people are trying to meditate! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{unhappy.png}
...
When I was at Cambridge, a very good friend of mine said that he had just volunteered to do some social work at a hospital where people with Down’s syndrome were institutionalised. I was busy, but if my friend went, I had to! It was pride. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{teeth.png} That’s all it was. 

But in the end, I felt thankful to my friend for getting me to go there because I helped there for two years, and it was not service at all. I went there because I enjoyed it! \includegraphics[scale=0.35, trim = 0 10 0 10 ]{star.png} I looked forward to those Thursday afternoons because I valued being taught and inspired by people who were locked away by the society. (This was in 1960s, 1970s.) 
...
I said to her, “That’s not how you get peace in life. If you think you are not where you should be, how about lowering \emph{where you think you should be} to \emph{where you are}? Then you’re at peace.” She got it. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{smile.png}
...
This is how to be kind. Don’t fight too much. Don’t fight battles which you can never win. You’ll have your depressed times, but they will pass. There’s nothing wrong with that. \includegraphics[scale=0.35, trim = 0 10 0 10 ]{star.png}
